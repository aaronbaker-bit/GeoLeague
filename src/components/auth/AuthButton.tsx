...
export default function AuthButton() {
  const { user, profile, loading, signInWithGoogle, signInWithDiscord, signOut, isAuthenticated } =
    useAuth();
          ...
          {showMenu && (
            ...
            >
              <button
                ...
                className="w-full flex items-center gap-3 px-3 py-2.5 text-sm text-zinc-200 hover:bg-zinc-800 rounded-lg transition-colors"
              >
              ...
              <button
                onClick={() => { signInWithDiscord(); setShowMenu(false); }}
                className="w-full flex items-center gap-3 px-3 py-2.5 text-sm text-zinc-200 hover:bg-zinc-800 rounded-lg transition-colors"
              >
